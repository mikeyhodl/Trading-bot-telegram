...
use ccxt\abstract\bitmex as Exchange;
...
class bitmex extends Exchange {
    ...
    public function fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($paginate) {
            return $this->fetch_paginated_call_deterministic('fetchOHLCV', $symbol, $since, $limit, $timeframe, $params);
        }
    ...
    public function fetch_liquidations(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($paginate) {
            return $this->fetch_paginated_call_dynamic('fetchLiquidations', $symbol, $since, $limit, $params);
        }
        $market = $this->market($symbol);
        $request = array(
            'symbol' => $market['id'],
